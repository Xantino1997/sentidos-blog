...
export default function LifePage() {
  ...
  useEffect(() => {
    fetch('https://backend-blog-psi.vercel.app/post')
      ...
      .then(data => {
        const medicinaPosts = data.filter(post => post.category === 'Bullying');
  ...
  return (
    <div className="container-not-content">
      <h1 style={{ textAlign: "center" , color:"red"}}>No se han creado posts en Bullying</h1>
      <img

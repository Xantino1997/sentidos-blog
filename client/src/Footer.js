        ...
        <footer>
            <div className="footer-content">
                ...
                <div className="footer-social">
                    ...
                    <a className="footer-facebook" href="https://www.youtube.com/watch?v=XRYLY4qlipE&t=18s" target="_blank"><img className="img-footer-facebook" src={youtube} alt="Facebook" /></a>
